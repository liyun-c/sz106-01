...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "fjjiADDZTL-gfG6CwxS7m-MVbIjUonaHnauJgEo5";
    private static final String SECRETKEY = "J5OpBUicNcXzqKOKICxwu5TeKr0fUP2kJhkXkwet";
    private static final String BUCKET = "hominspace";
    //public static final String DOMAIN = "http://qmld5x5bv.hn-bkt.clouddn.com/";
    public static final String DOMAIN = "http://qmlzuclga.hn-bkt.clouddn.com/";
    private static long logTimestemp4Toke = 0l;
    private static String token = null;

    public static void main(String[] args) {
        uploadFile("D:\\pp\\003.jpg","003.jpg");
    ...
    public static List<String> removeFiles(String... filenames){
        ...
        if(filenames.length > 0){
            ...
            try {
                ...
                e.printStackTrace();
                throw new RuntimeException(MyMessageConstant.PIC_UPLOAD_FAIL);
            }
        }
